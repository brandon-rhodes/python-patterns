...
*The universal pattern by which Python modules
make functions, classes, constants, and user class instances
available under well-known names.*
...
but without at all agreeing on the capitalization.
