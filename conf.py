...
# -*- coding: utf-8 -*-
#
# Python Patterns documentation build configuration file, created by
...
project = 'Python Patterns'
copyright = '2016, Brandon Rhodes'
...
#
# html_title = 'Python Patterns v1.0'
...
latex_documents = [
    (master_doc, 'PythonPatterns.tex', 'Python Patterns Documentation',
     'Brandon Rhodes', 'manual'),
]
...
man_pages = [
    (master_doc, 'pythonpatterns', 'Python Patterns Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonPatterns', 'Python Patterns Documentation',
     author, 'PythonPatterns', 'One line description of project.',
     'Miscellaneous'),
]
